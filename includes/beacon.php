...
class Beacon_CRM_Integration
{
    ...
    private function __construct()
    {
        ...
        // --- Tabbed Product Meta Fields (Simple - MULTIPLE) ---
        add_filter('woocommerce_product_data_tabs', [$this, 'add_beacon_product_data_tab']);
        add_action('woocommerce_product_data_panels', [$this, 'render_simple_product_fields']);
    ...
    public function render_simple_product_fields()
    {
        ...
        echo '<div id="beacon_crm_product_data" class="panel woocommerce_options_panel hidden">';
