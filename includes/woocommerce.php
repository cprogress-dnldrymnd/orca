...
/*
function create_beacon_data($body, $api_slug = 'person/upsert', $method = "PUT")
{
    $api_url = 'https://api.beaconcrm.org/v1/account/26878/entity/' . $api_slug;
...
function custom_action_after_order_created($order_id)
{
    ...
    $data = create_beacon_data($body_person);
    $id = $data['entity']['id'];
    
    $body_training = [
        "primary_field_key" => "c_name",
        "entity" => [
           'c_name' => 'Test Training',
           'c_person' => [$id],
           'c_course' => [86376],
        ],
    ];
